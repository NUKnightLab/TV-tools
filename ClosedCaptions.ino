/* This file is mostly taken from the Nootropic closed caption project example.
 *
 * Details available at http://nootropicdesign.com/projectlab/2011/03/20/decoding-closed-captioning/
 */
#include <TVout.h>
#include <fontALL.h>
